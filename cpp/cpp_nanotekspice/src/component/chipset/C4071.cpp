...
C4071::C4071(nts::Tristate &value) : Component()
{
	_value = value;
	_nbPins = 14;
	initOutputMap();
...
nts::IComponent** C4071::getPins() const
{
	return (nts::IComponent**)_pins;
}

std::size_t C4071::getOtherPin(std::size_t pin, bool _switch)
{
	if (_switch)
...
bool C4071::checkNotNull(std::size_t pin)
{
